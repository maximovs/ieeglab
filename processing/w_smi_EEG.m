function [ EEG, data ] = w_smi_EEG( filepath_to_data, data_range, kernel, taus, EEG, data )
...
%     end
    ...
    [sym ,~ ] = symbolic_transfer(selected_epoched_EEG.data,kernel, fs, taus, point_range,data.path,filename_to_save);

    mutual_information(data.path, filename_to_save, sym, taus);
    disp('done suj')
end
return