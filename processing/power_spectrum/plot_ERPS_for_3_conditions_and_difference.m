...
EEG_condition_3 = filter_epochs(condition_3, EEG, data);
%Condition1
%calculate ERPS
...
%Diff: 1 - 3 
file_2_save = fullfile(path_to_save, [files_prefix '-' condition_1 '-' condition_3]);
PlotERPSForDiffConditions(erpsByROIsCond1,erpsByROIsCond3,file_2_save,path_to_save,gCond3,PbootCond3,ERPCond3,mbaseCond3,freqsCond3,timesoutCond3,roi_struct);

%Diff: 2 - 3 
file_2_save = fullfile(path_to_save, [files_prefix '-' condition_2 '-' condition_3]);
PlotERPSForDiffConditions(erpsByROIsCond2,erpsByROIsCond3,file_2_save,path_to_save,gCond2,PbootCond2,ERPCond2,mbaseCond2,freqsCond2,timesoutCond2,roi_struct);
