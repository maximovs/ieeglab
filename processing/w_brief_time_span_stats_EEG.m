function [ EEG, data ] = w_brief_time_span_stats_EEG(filepath_to_data, filepath_to_save, condition1, condition2, bandpass_ranges, time_ranges,stat_method,alpha,EEG, data )
