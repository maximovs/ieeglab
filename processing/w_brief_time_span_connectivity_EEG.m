function [EEG, data] = w_brief_time_span_connectivity_EEG(path_to_files,condition_1, condition_2,bandpass_ranges,epoch_window,base_window,time_ranges,path_to_save,newFileName,EEG,data)
